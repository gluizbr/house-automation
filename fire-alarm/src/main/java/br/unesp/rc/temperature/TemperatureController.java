...
public class TemperatureController {
  ...
  @ResponseStatus(HttpStatus.OK)
  @GetMapping
  public List<TemperatureSensor> findAllTemperatureSensor() {
    return temperatureService.findAll();
  }

  @ResponseStatus(HttpStatus.OK)
  @GetMapping("/{temperatureId}")
  public TemperatureSensor findById(@PathVariable("temperatureId") String temperatureId) {
    return temperatureService.findById(temperatureId);
  }
